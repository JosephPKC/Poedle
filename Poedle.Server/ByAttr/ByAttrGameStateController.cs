...
namespace Poedle.Server.ByAttr
{
    ...
    public class ByAttrGameStateController : ControllerBase
    {
        ...
        private readonly PoeDbManager _manager = PoeDbManager.Instance;
        ...
        public IEnumerable<UniqueItemModel> GetAllItemAttributes()
        {
        ...
        public GuessResult GetGuessResult(int guessId, int answerId)
        {
            ...
            UniqueItemModel actual = _manager.GetItem(answerId);
            UniqueItemModel guess = _manager.GetItem(guessId);
