...
import { HintsArea, NullableAllHints } from "./hints.tsx";
import { ResultsArea, NullableAttrResult, NullableAttrResultList } from "./result.tsx";
...
interface ResultsAreaProps {
    ...
    readonly results: NullableAttrResultList
}
...
function GameArea({ isWin, hintsArea, gameEndArea, resultsArea, guessArea } : GameAreaProps) {
    const gameArea = isWin ?
        <>
            <HintsArea hints={hintsArea.hints} isWin={true} />
            <GameEndArea stats={gameEndArea.stats!} onClickPlayAgain={gameEndArea.onClickPlayAgain} onClearStats={gameEndArea.onClearStats} />
            <ResultsArea headers={resultsArea.headers} results={resultsArea.results} />
        </> :
        <>
            <HintsArea hints={hintsArea.hints} isWin={false} />
...
export function UniqueItemsGame() {
    ...
    const headers = [
        "Name", "Class", "Rq Lvl", "Rq Dex", "Rq Int", "Rq Str", "Special", "League", "Drop Source", "Drop Type"
    ];
    ...
    const guessArea: GuessAreaProps = {
        ...
        placeHolder: "Choose a Unique Item"
    }
