...
import "./skill-gems-game.css";

export function SkillGemsGame() {
    const api: GeneralApi = new GeneralApi("Poedle", ApiTypes.SkillGems);
    ...
    const selectOptions: GuessSelectOptions = {
        ...
        maxMenuHeight: 250,
        matchFrom: "any",
        placeHolder: "Select a Skill Gem"
    }
    ...
    const statsArea: StatsAreaProps = {
        ...
        answerClassName: "txt-skill-gem"
    };

    return (
        <div className="div-game">
            <PageTitle gameType="Skill Gem" />
...
function GameArea({ isWin, guessesArea, hintsArea, resultsArea, statsArea }: GameAreaProps) {
    ...
    const gameArea = isWin ?
        <>
            <SkillGemsHintsArea hints={hintsArea.hints} isWin={true} />
            ...
            <SkillGemResultsArea results={resultsArea.results} />
        </> :
        <>
            <SkillGemsHintsArea hints={hintsArea.hints} isWin={false} />
